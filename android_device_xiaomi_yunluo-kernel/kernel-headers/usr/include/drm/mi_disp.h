...
static __inline__ int isSupportDispId(int disp_id)
{
...
static __inline__ const char *getDispIdName(int disp_id)
{
	switch (disp_id) {
...
static __inline__ int isSupportDispFeatureId(int feature_id)
{
...
static __inline__ const char *getDispFeatureIdName(int feature_id)
{
	switch (feature_id) {
